...
def generate_password():
    ...
    letters=['a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','w','e','r','s'
    ,'t','u','v','w','x','y','z','A','B','C','D','E','F','G','H','I','J','H','I','J','K','L','M','N'
    ...
    # generate password in password entry
...
def save():
    ...
    if len(website) == 0 or len(password) == 0:
        ...
        try:
            ...
            password_entry.delete(0, END)
            messagebox.showinfo(title="Message", message="saved!!")
...
window.config(padx=50, pady=50, bg="Aquamarine")

canvas = Canvas(height=200, width=200, bg="Aquamarine", highlightthickness=0)
